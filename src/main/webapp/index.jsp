...
<header>
    ...
    <div class="header-container">
        <div class="search-bar">
            <img class="logo" src="./Images/pinkart2.png" alt="logo">
        ...
        <div class="navbar">
            ...
            <div class="links">
                <ul>
                    ...
                    <li><a
                            href="https://www.mercadolibre.com/jms/mco/lgz/msl/login/H4sIAAAAAAAEAy2NQY7DIBAE_9JnZN855htRhMYwOGgHYw3jkCjK3yPv7rFbXdVvSFvLFuy1Mzw6i8BhF7LctIaS4FHPqhfj_xjbOSGlysba4d-nZOV04dz01GSSznCgw-4hSxvwfz9wKD3w01g3kjB4eRQe8L-Aw9rgcTfbu5_nMcZUWSOlJmVRnmKrU2zzfixSIik-Dpm6BVOKP_CmBzskjlI2TvDX2-cLi2q64N4AAAA/notregistered">Vender</a>
                    </li>
            ...
            <div class="account">
                <ul>
                    ...
                    <li><a href="signup.html">Ingresa</a></li>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img class="flowers"
                 src="./Images/colour-1241879_1920.jpg"
                 class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="./Images/emotions-3459666_1920.jpg" class="d-block w-100"
                 alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
            <img src="./Images/banner-1763476_1920.jpg" class="d-block w-100"
                 alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                PinkTarjetas
                <button id="btnshowmor" type="button" class="btn btn-primary" data-bs-toggle="modal"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    <img src="./Images/mercado-pago.svg" alt="">
                                    ...
                                    <br>
                                    <img src="./Images/payment-agreement.svg" alt="">
                                    ...
                                    <br>
                                    <img src="./Images/account-money.svg" alt="">
            ...
            <div class="col">
                <img src="./Images/transfer.svg" alt="Transferencia">
            ...
            <br>
            <div class="col">
                <img src="./Images/payment-agreement.svg" alt="Efectivo">
                Paga en PinkEfectivo
                <button id="btnshowmo" type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
                    <p style="color: pink;">Pink Opciones</p>
                </button>
            </div>
            <div class="col">
                <img src="./Images/view-more.svg" alt="More payments">
                Más medios de Pinkpago
                <br>
                <button id="btnshowm" type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
                    <p style="color: pink;">Pink Opciones</p>
                </button>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <img src="./Images/protected.svg" alt="">
        ...
        <div class="links-footer">
            <ul>
                <li><a href="">Has parte de nuestra Pink familia y trabaja con noSotros </a></li>
